function onOpen() {
  SpreadsheetApp.getUi().createMenu('FlipTracker Pro')
    .addItem('Install / Repair v0.7.1','installFlipTrackerPro')
    ...
    .addItem('Inventory Health Summary','showInventoryHealthSummary71_')
    .addItem('Refresh Inventory Health','repairInventoryHealth')
    .addSeparator()
