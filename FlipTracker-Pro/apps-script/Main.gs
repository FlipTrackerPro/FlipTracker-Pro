function installFlipTrackerPro() {
  ...
  p.setProperty('FTP_SCHEMA_VERSION','4.1'); p.setProperty('FTP_APP_VERSION',FTP3.VERSION);
...
function upgradeFlipTrackerPro() {
  ...
  p.setProperty('FTP_SCHEMA_VERSION','4.1'); p.setProperty('FTP_APP_VERSION',FTP3.VERSION);
  SpreadsheetApp.getActive().toast('FlipTracker Pro upgraded to schema 4.1.','FlipTracker Pro',6);
}
