...
function installFlipTrackerPro() {
  ...
  repairWholeNumberValues3_();
  applyFlipTrackerNumberFormats3_();
  p.setProperty('FTP_SCHEMA_VERSION','5.7'); p.setProperty('FTP_APP_VERSION',FTP3.VERSION);
  goToDashboardSprint3();
  SpreadsheetApp.getActive().toast('FlipTracker Pro v0.5.7 is ready.','FlipTracker Pro',6);
}
...
function upgradeFlipTrackerPro() {
  ...
  applyFlipTrackerNumberFormats3_();
  p.setProperty('FTP_SCHEMA_VERSION','5.7'); p.setProperty('FTP_APP_VERSION',FTP3.VERSION);
  SpreadsheetApp.getActive().toast('FlipTracker Pro upgraded to schema 5.7.','FlipTracker Pro',6);
}
