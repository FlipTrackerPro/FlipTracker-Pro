...
function installFlipTrackerPro() {
  ...
  repairWholeNumberValues3_();
  applyFlipTrackerNumberFormats3_();
  p.setProperty('FTP_SCHEMA_VERSION','6.1'); p.setProperty('FTP_APP_VERSION',FTP3.VERSION);
  goToDashboardSprint3();
  SpreadsheetApp.getActive().toast('FlipTracker Pro v0.6.1 is ready.','FlipTracker Pro',6);
}
...
function upgradeFlipTrackerPro() {
  ...
  applyFlipTrackerNumberFormats3_();
  p.setProperty('FTP_SCHEMA_VERSION','6.1'); p.setProperty('FTP_APP_VERSION',FTP3.VERSION);
  SpreadsheetApp.getActive().toast('FlipTracker Pro upgraded to schema 6.1.','FlipTracker Pro',6);
}
